...
module.exports = function(obj) {
    ...
    return {
        ...
        package: {
            ...
            version: obj.package.version || process.env.npm_package_version || '1.0.0',
            ...
            rights: obj.package.rights || `© ${obj.organization || ''}. All rights reserved.`,
            requirements: obj.package.requirements || [],
            keywords: stringToArray(obj.package.keywords || ''),
            status: obj.package.status || 'final',
            vcard: {
                version: obj.package.vcard.version || obj.package.version || process.env.npm_package_version || '1.0.0',
            ...
            zip: obj.package.zip,
            appendTimeToOutput: typeof obj.package.appendTimeToOutput === 'boolean' ? obj.package.appendTimeToOutput : false
        },
